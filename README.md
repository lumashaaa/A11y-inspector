...
- ** Мультиформатные отчеты** (JSON, HTML, CSV, Markdown)
...
### CSV
Табличный формат для импорта в Excel, Google Sheets или другие инструменты анализа.

### Markdown
Удобный формат для документации и отчетов в системах контроля версий.
